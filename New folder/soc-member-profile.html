...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Member Profile</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="soc-member-profile.html" >Member Profile</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="uprofile-image">
                                            <img src="data/soc-members/member-1.jpg" class="img-fluid">
                                        </div>
                                        <div class="uprofile-name">
                                            <h3>
                                                <a href="#">Mr. John Wilson</a>
                                                <!-- Available statuses: online, idle, busy, away and offline -->
                                                <span class="uprofile-status online"></span>
                                            </h3>
                                            <p class="uprofile-title">Web Designer</p>
                                        </div>
                                        <p class='text-center'>Has created designs for all the kinds of niche and industires. Dedicated life to web programming.</p>
