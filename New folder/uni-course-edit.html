...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Edit Course</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="uni-course-edit.html" >Edit Course</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Edit Course</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="Web Design Tutorials" class="form-control" id="field-1">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Starts From</label>
                                                <span class="desc">e.g. "04/03/2015"</span>
                                                <div class="controls">
                                                    <input type="text" value="5th Dec 2015" class="form-control datepicker" data-format="mm/dd/yyyy" value="">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Course Time Length</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="3 months" class="form-control" id="field-1">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Course Price</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="$400.00" class="form-control" id="field-1">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Professor</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Prof. John Doug" class="form-control" id="field-1">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Course Image</label>
                                                <span class="desc"></span>
                                                <img class="img-fluid" src="data/courses/course-1.jpg" alt="" style="max-width:120px;">
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control ">
                                                    <option></option>
                                                    <option selected='selected' value="Computer Engineering">Computer Engineering</option>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Year</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Last Year" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">Well structured and deep knowledge in the subject is given in this course along with live practical examples.</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control"  value="http://www.example.com" id="field-51">
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Course Social Media Info</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <form action="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control"  value="http://www.facebook.com/courseID" id="field-31">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control"  value="http://www.twitter.com/courseID" id="field-41">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control"  value="http://www.plus.google.com/courseID" id="field-51">
                                                </div>
                                            </div>
