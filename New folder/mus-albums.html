...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Albums</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="mus-albums.html" >All Albums</a>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">All Albums</h2>
                                            ...
                                            <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                <div class="team-member ">
                                                    ...
                                                    <div class="team-info ">
                                                        ...
                                                        <span class='team-member-edit'><a href="mus-album-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
