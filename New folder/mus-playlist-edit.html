...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Edit Playlist</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="mus-playlist-edit.html" >Edit Playlist</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Edit Playlist</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Playlist Title</label>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Playlist Artist</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Playlist Time Length</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Playlist Cover Image</label>
                                                <span class="desc"></span>
                                                <img class="img-fluid" src="data/playlists/playlist-1.jpg" alt="" style="max-width:120px;">
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">Most famous songs are included in this playlist. All are hilarious to listen</textarea>
                                                </div>
                                            </div>
