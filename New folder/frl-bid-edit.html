...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Edit Bid</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="frl-bid-edit.html" >Edit Bid</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Edit Bid</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Bid ID</label>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Date of Bid</label>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Bid Status</label>
                                                <span class="desc"></span>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Buyer</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Seller</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Infotech Inc." class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">Seller agrees to provide all the services to buyer, as per project description in alloted period of time.</textarea>
                                                </div>
                                            </div>
