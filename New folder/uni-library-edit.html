...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Edit Library Asset</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="uni-library-edit.html" >Edit Library Asset</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Edit Library Asset</h1>                            </div>
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>Edit Library Asset</strong>
                                    </li>
                                </ol>
                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="Computer Coding Standards" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Computer Programming" class="form-control" id="field-1">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Library Asset Price</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="$30.00" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Prof. Mark A." class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Asset Type</label>
                                                <span class="desc"></span>
                                                <select class="form-control">
                                                    <option></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">Full info of the library asset can be added here</textarea>
                                                </div>
                                            </div>
