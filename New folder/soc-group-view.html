...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Group Profile</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="soc-group-view.html" >View Group</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Group Profile</h1>                            </div>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="uprofile-image">
                                            <img src="data/soc-groups/group-1.jpg" class="img-fluid">
                                        </div>
                                        <div class="uprofile-name">
                                            <h3>
                                                <a href="#">Designer Group</a>
                                                <!-- Available statuses: online, idle, busy, away and offline -->
                                                <span class="uprofile-status online"></span>
                                            </h3>
                                            <p class="uprofile-title">John Willy</p>
                                        </div>
                                        <div class="uprofile-buttons">
                                            <a class="btn btn-md btn-primary">Join Group</a>
                                            <a class="btn btn-md btn-primary">Invite Friends</a>
                                        </div>
