...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Playlist Profile</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="mus-playlist-view.html" >View Playlist</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Playlist Profile</h1>                            </div>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="uprofile-image">
                                            <img src="data/playlists/playlist-1.jpg" class="img-fluid">
                                        </div>
                                        <div class="uprofile-name">
                                            ...
                                            <p class="uprofile-title">Max Yurey</p>
                                        </div>

                                        <div class="uprofile-buttons">
                                            <a class="btn btn-md btn-primary">Follow</a>
                                            <a class="btn btn-md btn-primary">Listen Song</a>
                                        </div>
                                    ...
                                    <div class="col-md-9 col-sm-8 col-xs-12">
                                        ...
                                        <div class="uprofile-content">
                                            ...
                                            <h4>About this Playlist:</h4><p>Music is an art form, social activity or cultural activity whose medium is sound and silence. The common elements of music are pitch (which governs melody and harmony), rhythm (and its associated concepts tempo, meter, and articulation), dynamics (loudness and softness).</p><br><table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        <th style="width:10%">Play</th>
                                                        <th style="width:60%">Song Name</th>
                                                        <th style="width:30%">Trending Data</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><i class="fa fa-play-circle icon-primary icon-sm"></i></td>
                                            ...
                                            <div class="uprofile_wall_posts col-lg-12 col-md-12 col-12">
                                                <div class="row margin-0">
                                                    <div class="pic-wrapper col-lg-1 col-md-1 col-2 text-center">
                                                        <img src="data/profile/avatar-2.png" class="" alt="">
                                                    </div>
                                                    <div class="info-wrapper col-lg-11 col-md-11 col-10">                   
                                                        <div class="username">
                                                        ...
                                                        <div class="info-details">
                                                            <ul class="list-unstyled list-inline">
                                                                ...
                                                                <li class="list-inline-item"><a href="#" class="text-orange"><i class="fa fa-heart"></i> 12k</a></li>
                                                                ...
                                                                <div class="info-wrapper col-lg-11 col-md-11 col-10">                   
                                                                    ...
                                                                    <div class="info-details">
                                                                        <ul class="list-unstyled list-inline">
                                                                            ...
                                                                            <li class="list-inline-item"><a href="#" class="text-orange"><i class="fa fa-heart-o"></i> Like</a></li>
                                                                            <li class="list-inline-item"><a href="#" class="text-muted">More</a></li>
                                                                        </ul>
                                                                    </div>
                                                                ...
                                                                <div class="info-wrapper col-lg-11 col-md-11 col-10">                   
                                                                    ...
                                                                    <div class="info-details">
                                                                        <ul class="list-unstyled list-inline">
                                                                            ...
                                                                            <li class="list-inline-item"><a href="#" class="text-orange"><i class="fa fa-heart"></i> Liked</a></li>
                                                                            <li class="list-inline-item"><a href="#" class="text-muted">More</a></li>
                                                                        </ul>
                                                                    </div>
                                                        ...
                                                        <div class="comment comment-input">                         
                                                            <div class="row margin-0">
                                                                ...
                                                                <div class="info-wrapper col-lg-11 col-md-11 col-10">                   
                                                                    <div class="input-group primary  col-lg-6">
