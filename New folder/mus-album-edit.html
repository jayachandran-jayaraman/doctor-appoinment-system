...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Edit Album</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="mus-album-edit.html" >Edit Album</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Edit Album</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Album Title</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Heart of the Ocean" class="form-control" id="field-1">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Album Artist</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="Max Yurey" class="form-control" id="field-1">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Album Time Length</label>
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="01:34:40" class="form-control" id="field-1">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="field-1">Album Cover Image</label>
                                                <span class="desc"></span>
                                                <img class="img-fluid" src="data/albums/album-1.jpg" alt="" style="max-width:120px;">
                                                <div class="controls">
                                                    <input type="file" class="form-control" id="field-5">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Select Songs</label>
                                                <span class="desc"></span>
                                                <select multiple class="form-control">
                                                    <option selected='selected'>Song of the ocean</option>
                                                    <option>Giant Mammoth</option>
                                                    <option selected='selected'>In the winter</option>
                                                    <option selected='selected'>Gentle Rains</option>                                    
                                                    <option>Giant Mammoth</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">Most famous songs are included in this album. All are hilarious to listen</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">Album Social Media Info</h2>
                                <div class="actions panel_actions float-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <form action="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control"  value="http://www.facebook.com/albumID" id="field-31">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control"  value="http://www.twitter.com/albumID" id="field-41">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" class="form-control"  value="http://www.plus.google.com/albumID" id="field-51">
                                                </div>
                                            </div>
