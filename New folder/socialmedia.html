...
<html class=" ">
    <head>
        ...
        <link href="assets/plugins/jquery-ui/smoothness/jquery-ui.min.css" rel="stylesheet" type="text/css" media="screen"/><link href="assets/plugins/jvectormap/jquery-jvectormap-2.0.1.css" rel="stylesheet" type="text/css" media="screen"/>        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="socialmedia.html"  target = '_blank' >Social Media Admin</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                        ...
                        <div class="page-title">
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>Social Media Admin</strong>
                                    </li>
                                </ol>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="r1_graph1 db_box db_box_large">
                                            ...
                                            <span class='float-right'><small>New/Repeating Users</small></span>
                                            <div class="clearfix"></div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="r1_graph2 db_box db_box_large">
                                            ...
                                            <span class='float-right'><small>Links Shared</small></span>
                                            <div class="clearfix"></div>
                                    ...
                                    <div class="col-lg-4 hidden-sm col-md-12 col-12">

                                        <div class="r1_graph1 db_box db_box_large">
                                            <span class='bold'>67/98</span>
                                            <span class='float-right'><small>Total / Unique visitors</small></span>
                                            <div class="clearfix"></div>
                    ...
                    <div class="row margin-0">
                        ...
                        <div class="col-xl-6">
                            <section class="box ">
                                <header class="panel_header">
                                    <h2 class="title float-left">Trending Users</h2>
                                    <div class="actions panel_actions float-right">
                                        <i class="box_toggle fa fa-chevron-down"></i>
                                        <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                        <i class="box_close fa fa-times"></i>
