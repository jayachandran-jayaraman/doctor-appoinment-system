...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Students</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                <li>
                                    <a class="active" href="uni-students.html" >All Students</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Students</h1>                            </div>
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="uni-students.html">Students</a>
                                    </li>
                                    <li class="active">
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title float-left">All Students</h2>
                                            ...
                                            <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                <div class="team-member ">
                                                    <div class="row margin-0">
                                                        <div class="team-img ">
                                                            <img class="img-fluid" src="data/students/student-1.jpg" alt="">
                                                            ...
                                                            <span class='team-member-edit'><a href="uni-student-edit.html"><i class='fa fa-pencil icon-xs'></i></a></span>
                                                ...
                                                <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                    <div class="team-member ">
                                                        <div class="row margin-0">
                                                            <div class="team-img ">
                                                                <img class="img-fluid" src="data/students/student-2.jpg" alt="">
                                                            </div>                         <div class="team-info ">
                                                                <h4>
                                                    ...
                                                    <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                        <div class="team-member ">
                                                            <div class="row margin-0">
                                                                <div class="team-img ">
                                                                    <img class="img-fluid" src="data/students/student-3.jpg" alt="">
                                                                </div>                         <div class="team-info ">
                                                                    <h4>
                                                        ...
                                                        <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                            <div class="team-member ">
                                                                <div class="row margin-0">
                                                                    <div class="team-img ">
                                                                        <img class="img-fluid" src="data/students/student-4.jpg" alt="">
                                                                    </div>                         <div class="team-info ">
                                                                        <h4>
                                                            ...
                                                            <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                <div class="team-member ">
                                                                    <div class="row margin-0">
                                                                        <div class="team-img ">
                                                                            <img class="img-fluid" src="data/students/student-5.jpg" alt="">
                                                                        </div>                         <div class="team-info ">
                                                                            <h4>
                                                                ...
                                                                <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                    <div class="team-member ">
                                                                        <div class="row margin-0">
                                                                            <div class="team-img ">
                                                                                <img class="img-fluid" src="data/students/student-6.jpg" alt="">
                                                                            </div>                         <div class="team-info ">
                                                                                <h4>
                                                                    ...
                                                                    <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                        <div class="team-member ">
                                                                            <div class="row margin-0">
                                                                                <div class="team-img ">
                                                                                    <img class="img-fluid" src="data/students/student-7.jpg" alt="">
                                                                                </div>                         <div class="team-info ">
                                                                                    <h4>
                                                                        ...
                                                                        <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                            <div class="team-member ">
                                                                                <div class="row margin-0">
                                                                                    <div class="team-img ">
                                                                                        <img class="img-fluid" src="data/students/student-8.jpg" alt="">
                                                                                    </div>                         <div class="team-info ">
                                                                                        <h4>


                                                                                            <a href="uni-student-profile.html">
                                                                                                Jacqueline Collins</a>
                                                                            ...
                                                                            <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                                <div class="team-member ">
                                                                                    <div class="row margin-0">
                                                                                        <div class="team-img ">
                                                                                            <img class="img-fluid" src="data/students/student-9.jpg" alt="">
                                                                                        </div>                         <div class="team-info ">
                                                                                            <h4>
                                                                                ...
                                                                                <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                                    <div class="team-member ">
                                                                                        <div class="row margin-0">
                                                                                            <div class="team-img ">
                                                                                                <img class="img-fluid" src="data/students/student-10.jpg" alt="">
                                                                                            </div>                         <div class="team-info ">
                                                                                                <h4>
                                                                                    ...
                                                                                    <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                                        <div class="team-member ">
                                                                                            <div class="row margin-0">
                                                                                                <div class="team-img ">
                                                                                                    <img class="img-fluid" src="data/students/student-11.jpg" alt="">
                                                                                                </div>                         <div class="team-info ">
                                                                                                    <h4>
                                                                                        ...
                                                                                        <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                                                                            <div class="team-member ">
                                                                                                <div class="row margin-0">
                                                                                                    <div class="team-img ">
                                                                                                        <img class="img-fluid" src="data/students/student-12.jpg" alt="">
                                                                                                    </div>                         <div class="team-info ">
                                                                                                        <h4>
