...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Edit Quote</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="crm-quote-edit.html" >Edit Quote</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Edit Quote</h1>                            </div>
                                    ...
                                    <form action ="#" method="post">
                                        <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="Corporate Website" class="form-control" id="field-1">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Type</label>
                                                <span class="desc"></span>
                                                <select class="form-control">
                                                    <option></option>
                                                    <option selected='selected'>Web Designing</option>
                                                    <option>SEO</option>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="field-5">Date of Quotation</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="$40.00" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="text" value="$50.00" class="form-control" id="field-1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" cols="5" id="field-6">Client asked to create a new website for this business. It was completed as per description and customer satisfaction.</textarea>
                                                </div>
                                            </div>
