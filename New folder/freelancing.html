...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Freelancing</title>
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="freelancing.html"  target = '_blank' >Freelancing Admin</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Freelancing</h1>                            </div>
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>Freelancing Admin</strong>
                                    </li>
                                </ol>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="r4_counter db_box">
                                            <i class='float-left fa fa-dollar icon-md icon-rounded icon-primary'></i>
                                            <div class="stats">
                                                <h4><strong>$950K</strong></h4>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="r4_counter db_box">
                                            <i class='float-left fa fa-thumbs-up icon-md icon-rounded icon-orange'></i>
                                            <div class="stats">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="r1_maingraph db_box">
                                            <span class='float-left'>
                                                <i class='icon-purple fa fa-square icon-xs'></i>&nbsp;
                                                <small>Buyers</small>&nbsp; &nbsp;
                                                <i class='fa fa-square icon-xs icon-primary'></i>&nbsp;
                                                <small>Projects</small>&nbsp; &nbsp;
                                                <i class='fa fa-square icon-xs icon-orange'></i>&nbsp;
                                                <small>Sellers</small>
                                            </span>
