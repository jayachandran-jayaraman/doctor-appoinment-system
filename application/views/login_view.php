...
<body>
    <div class="login-container">
        ...
        <div class="login-body">
            ...
            <!-- Login Form -->
            <form action="<?= base_url('index/do_login')?>" method="POST">
                <div class="mb-3">
                ...
                <button type="submit" name ="submit" class="btn btn-login">
                    <i class="fas fa-sign-in-alt me-2"></i> Login to Patient Portal
                </button>
            </form>
            ...
            <div class="register-section text-center border-top pt-4 mt-4">
                ...
                <a href="<?=base_url('index/signup')?>" class="btn btn-register btn-sm">
