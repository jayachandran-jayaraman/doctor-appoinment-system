...
<div class="container">
  ...
  <form method="post" action="<?=base_url('admin/signup')?>" onsubmit="return validatePasswords()">
    <!-- Name Field -->
    <div class="row">
      <div class="col-25">
    ...
    <div class="col-md-4 mb-3">
                <label for="doctor" class="form-label">Role</label>
                <select name="role" class="form-select" required>
                  <option value="" selected disabled>Choose a doctor</option>
                  <option value="1">Admin Registration</option>
